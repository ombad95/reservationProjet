...
CREATE TABLE `artists` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_artist_troupe` (`troupe_id`),
  CONSTRAINT `fk_artist_troupe` FOREIGN KEY (`troupe_id`) REFERENCES `troupe` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `artists` VALUES (1,'Daniel','Marcelin',1),(2,'Philippe','Laurent',1),(3,'Marius','Von Mayenburg',1),(4,'Olivier','Boudon',1),(5,'Anne Marie','Loop',2),(6,'Pietro','Varasso',2),(7,'Laurent','Caron',2),(8,'Élena','Perez',2),(9,'Guillaume','Alexandre',3),(10,'Claude','Semal',3),(11,'Laurence','Warin',3),(12,'Pierre','Wayburn',3),(13,'Gwendoline','Gauthier',3);
...
INSERT INTO `flyway_schema_history` VALUES (1,'1.1','create artists table','SQL','V1_1__create_artists_table.sql',1930805307,'root','2025-05-21 17:29:38',133,1),(2,'1.2','insert artists table','SQL','V1_2__insert_artists_table.sql',-390020986,'root','2025-05-21 17:29:38',10,1),(3,'2.1','create users table','SQL','V2_1__create_users_table.sql',513360628,'root','2025-05-21 17:29:38',30,1),(4,'2.2','insert users table','SQL','V2_2__insert_users_table.sql',-1294094065,'root','2025-05-21 17:29:38',8,1),(5,'3.1','create localities table','SQL','V3_1__create_localities_table.sql',175429460,'root','2025-05-21 17:29:38',33,1),(6,'3.2','insert localities table','SQL','V3_2__insert_localities_table.sql',805785997,'root','2025-05-21 17:29:38',12,1),(7,'4.1','create roles table','SQL','V4_1__create_roles_table.sql',239598783,'root','2025-05-21 17:29:39',79,1),(8,'4.2','insert roles table','SQL','V4_2__insert_roles_table.sql',-1624113663,'root','2025-05-21 17:29:39',10,1),(9,'5.1','create types table','SQL','V5_1__create_types_table.sql',1925872095,'root','2025-05-21 17:29:39',39,1),(10,'5.2','insert types table','SQL','V5_2__insert_types_table.sql',-126045216,'root','2025-05-21 17:29:39',11,1),(11,'6.1','create locations table','SQL','V6_1__create_locations_table.sql',1736301610,'root','2025-05-21 17:29:39',216,1),(12,'6.2','insert locations table','SQL','V6_2__insert_locations_table.sql',1508143262,'root','2025-05-21 17:29:39',4,1),(13,'7.1','create shows table','SQL','V7_1__create_shows_table.sql',-892313632,'root','2025-05-21 17:29:39',211,1),(14,'7.2','insert shows table','SQL','V7_2__insert_shows_table.sql',-2085968838,'root','2025-05-21 17:29:39',10,1),(15,'8.1','create representations table','SQL','V8_1__create_representations_table.sql',-1708055491,'root','2025-05-21 17:29:40',370,1),(16,'8.2','create representations table','SQL','V8_2__create_representations_table.sql',1896858991,'root','2025-05-21 17:29:40',8,1),(17,'9.1','create artist type table','SQL','V9_1__create_artist_type_table.sql',1676507029,'root','2025-05-21 17:29:40',356,1),(18,'9.2','insert artist type table','SQL','V9_2__insert_artist_type_table.sql',-1003207613,'root','2025-05-21 17:29:40',8,1),(19,'10.1','create artist type show table','SQL','V10_1__create_artist_type_show_table.sql',220468303,'root','2025-05-21 17:29:41',215,1),(20,'10.2','insert artist type show table','SQL','V10_2__insert_artist_type_show_table.sql',-31123080,'root','2025-05-21 17:29:41',8,1),(21,'11.2','create user role table','SQL','V11_2__create_user_role_table.sql',-330443967,'root','2025-05-21 17:29:41',328,1),(22,'12.1','insert user role table','SQL','V12_1__insert_user_role_table.sql',425274378,'root','2025-05-21 17:29:41',7,1),(23,'12.2','create reservations table','SQL','V12_2__create_reservations_table.sql',1726137537,'root','2025-05-21 17:29:41',360,1),(24,'13.1','insert reservations table','SQL','V13_1__insert_reservations_table.sql',2074592799,'root','2025-05-21 17:29:41',7,1),(25,'14.1','create tags table','SQL','V14_1__create_tags_table.sql',1909949012,'root','2025-05-21 17:29:42',430,1),(26,'14.2','insert tags table','SQL','V14_2__insert_tags_table.sql',-1268063841,'root','2025-05-21 17:29:42',17,1),(27,'15.1','create troupe table','SQL','V15_1__create_troupe_table.sql',-480786200,'root','2025-05-21 17:29:42',35,1),(28,'15.2','insert troupe table','SQL','V15_2__insert_troupe_table.sql',563606562,'root','2025-05-21 17:29:42',9,1),(29,'16.1','alter artists table','SQL','V16_1__alter_artists_table.sql',1428005629,'root','2025-05-21 17:29:42',167,1),(30,'16.2','update artists table','SQL','V16_2__update_artists_table.sql',1213402731,'root','2025-05-21 17:29:42',15,1);
...
LOCK TABLES `troupe` WRITE;
/*!40000 ALTER TABLE `troupe` DISABLE KEYS */;
INSERT INTO `troupe` VALUES (1,'Troupe des Modernes','logo1.png'),(2,'Compagnie du Sud','logo2.png'),(3,'Collectif Nord-Est','logo3.png');
/*!40000 ALTER TABLE `troupe` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-21 20:00:14
